...
<html>
  ...
  <body>
	<div id="vLocation">
		当前位置&nbsp;：宠物管理&nbsp;&nbsp;<span class="divider">/</span>&nbsp;&nbsp;<a href="javascript:void(0)">添加宠物</a>
	</div>
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/pet/add" method="post" enctype="multipart/form-data">
			<table id="infoTable">
				<tr>
				...
				<tr>
					...
					<td class="rightTD"><input type="number" id="age" name="age"/>&nbsp;个月</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="rightTD"><input type="text" id="note" name="note" required="required"/></td>
				</tr>
				<tr>
