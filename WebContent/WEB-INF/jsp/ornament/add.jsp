...
<html>
  ...
  <body>
	<div id="vLocation">
		当前位置&nbsp;：饰品管理&nbsp;&nbsp;<span class="divider">/</span>&nbsp;&nbsp;<a href="javascript:void(0)">添加饰品</a>
	</div>
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/ornament/add" method="post" enctype="multipart/form-data">
			<table id="infoTable">
				<tr>
				...
				<tr>
					...
					<td class="rightTD"><input type="text" id="productionMaterial" name="productionMaterial" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD">单价</td>
					<td class="rightTD"><input type="text" id="unitPrice" name="unitPrice"/>&nbsp;元</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="rightTD">
						<textarea id="note" rows="5" cols="20" name="note"></textarea>
					</td>
				</tr>
				<tr>
