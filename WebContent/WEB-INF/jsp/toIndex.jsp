	...
	<div id="top">
		...
		<div style="width: 1000px;height: 1870px;border: 1px solid #ccc;margin: 10px auto;">
			<div class="goods" style="margin-top: 0px;">
				<div class="lb">
					&nbsp;&nbsp;&nbsp;宠物
					<a href="${pageContext.request.contextPath}/pet/all" class="more">更多&gt;&gt;</a>
				</div>
				<c:forEach items="${pets }" var="p" varStatus="st">
					<c:if test="${st.index+1 < 7}">
						<div class="pets">
							<img alt="${p.name }" src="${pageContext.request.contextPath}/${p.picLocation }" class="pic">
							<div style="height: 70px;width: 100%;">
								<p class="info">
									<strong style="font-family: '黑体';color: #EF617E;">${p.name }</strong>
								</p>
								<p class="info">
									<span style="color: #777;font-size: 12px;">RMB: ${p.unitPrice }.00</span>
									<span style="color: #777;font-size: 12px;margin-left: 10px;">${p.age }个月/${p.weight }kg</span>
								</p>
								<p class="info">
									<c:if test="${loginUser != null && role == '0' }">
										<a href="${pageContext.request.contextPath}/order/buy/pet/${p.id }"><button class="buy">购买</button></a>
										<a href="${pageContext.request.contextPath}/cart/add/pet/${p.id }"><button class="buy" style="width: 80px;">加入购物车</button></a>
									</c:if>
								</p>
							</div>
						</div>
			...
			<div class="goods" style="margin-top: 0px;">
				<div class="lb">&nbsp;&nbsp;&nbsp;零食<a href="${pageContext.request.contextPath}/food/all" class="more">更多&gt;&gt;</a></div>
				<c:forEach items="${foods }" var="f" varStatus="st">
					<c:if test="${st.index+1 < 7}">
						<div class="pets">
			...
			<div class="goods" style="margin-top: 0px;">
				<div class="lb">&nbsp;&nbsp;&nbsp;饰品<a href="${pageContext.request.contextPath}/ornament/all" class="more">更多&gt;&gt;</a></div>
				<c:forEach items="${ornaments }" var="o" varStatus="st">
					<c:if test="${st.index+1 < 7}">
						<div class="pets">
							<img alt="${o.name }" src="${pageContext.request.contextPath}/${o.picLocation }" class="pic">
							<div style="height: 70px;width: 100%;">
								<p class="info">
									<strong style="font-family: '黑体';color: #EF617E;">${o.name }</strong>
								</p>
								<p class="info">
									<span style="color: #777;font-size: 12px;">RMB: ${o.unitPrice }.00</span>
									<span style="color: #777;font-size: 12px;margin-left: 10px;">${o.productionMaterial }</span>
								</p>
								<p class="info">
									<c:if test="${loginUser != null && role == '0' }">
										<a href="${pageContext.request.contextPath}/order/buy/ornament/${o.id }"><button class="buy">购买</button></a>
										<a href="${pageContext.request.contextPath}/cart/add/ornament/${o.id }"><button class="buy" style="width: 80px;">加入购物车</button></a>
									</c:if>
								</p>
							</div>
						</div>
