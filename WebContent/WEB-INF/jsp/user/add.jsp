...
<html>
  ...
  <body>
	<div id="vLocation">
		当前位置&nbsp;：用户管理&nbsp;&nbsp;<span class="divider">/</span>&nbsp;&nbsp;<a href="javascript:void(0)">添加用户</a>
	</div>
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/user/add" method="post">
			<table id="infoTable">
				<tr>
				...
				<tr>
					...
					<td class="rightTD"><input type="password" id="password" name="password"/></td>
				</tr>
				<tr>
					<td class="leftTD">确认密码</td>
					<td class="rightTD"><input type="password" id="cfmPwd" name="cfmPwd"/></td>
				</tr>
				<tr>
					<td class="leftTD">邮箱</td>
					<td class="rightTD"><input type="text" id="email" name="email" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD">手机号码</td>
					<td class="rightTD"><input type="text" id="phone" name="phone" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD"></td>
