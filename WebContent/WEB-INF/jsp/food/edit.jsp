...
<html>
  ...
  <body>
	...
	<div id="infoDiv">
		<form id="saveForm" action="${pageContext.request.contextPath}/food/edit" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id" value="${f.id }"/>
			<input type="hidden" name="goodType" value="${f.goodType }"/>
			<input type="hidden" name="sid" value="${stock.id }"/>
			<table id="infoTable">
				<tr>
					<td class="leftTD">名称</td>
					<td class="rightTD"><input type="text" id="name" name="name" value="${f.name }"/></td>
				</tr>
				<tr>
					<td class="leftTD">单价</td>
					<td class="rightTD"><input type="number" id="unitPrice" name="unitPrice" value="${f.unitPrice }"/>&nbsp;元</td>
				</tr>
				<tr>
					<td class="leftTD">生产日期</td>
					<td class="rightTD"><input type="date" id="productionDateT" name="productionDateT" value="${f.productionDate }" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD">有效日期</td>
					<td class="rightTD"><input type="date" id="effectiveDateT" name="effectiveDateT" value="${f.effectiveDate }" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD">重量</td>
					<td class="rightTD"><input type="number" id="weight" name="weight" value="${f.weight }" required="required"/>&nbsp;kg</td>
				</tr>
				<tr>
					<td class="leftTD">介绍</td>
					<td class="rightTD"><input type="text" id="introduction" name="introduction" value="${f.introduction }" required="required"/></td>
				</tr>
				<tr>
					<td class="leftTD">备注</td>
					<td class="rightTD">
						<textarea id="note" rows="5" cols="15" name="note">${f.note }</textarea>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="rightTD">
						<img id="ImgPr" width="180" height="100" src="${pageContext.request.contextPath}/${f.picLocation }"/>
					</td>
				</tr>
				<tr>
